<nav class="menu <?php if($page_title == 'Home'){echo 'fixed';} ?>">
  <ul class="nav-logos">
    ...
    <li class="<?php if($page_title == 'Home'){echo 'hide-logo-text';} ?>"><a class="<?php if($page_title == 'Home'){echo 'scroll';} ?>" id="logo-type" href="<?php if($page_title == 'Home'){echo '#home';} else{echo 'index.php#home';} ?>"><h1 class="all-caps">The Final Draft</h1></a></li>
